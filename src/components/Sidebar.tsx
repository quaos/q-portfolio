...
export const Sidebar = ({
    ...
    return (
        <Component id={elementId} className={`sidebar main-sidebar${(visible) ? "" : " collapse"}`}>
...
export const SidebarLink = ({
    ...
    return (
        <NavLink Component={Component}
            ...
            <Icon key="link-icon" className="nav-link-icon" size="s" iconSet={link.iconSet} iconName={link.iconName} />
            &nbsp;<span key="link-title" className="nav-link-title">{link.title}</span>
        </NavLink>
    )
};
